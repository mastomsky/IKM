    ...
    <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="{{ route('responden.index') }}"
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            <img width="25" height="25" src="https://img.icons8.com/windows/32/survey.png" alt="survey"/>
            <span class="ml-3">Responden</span>
          </a>
        </li>
        <li>
        ...
        <li  style="visibility: {{ (Auth::user()->role_id != 'super' ? 'hidden': 'visible') }}">
        ...
        <hr>
        <li>
          <h5 class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white ">Setting</h5>
        </li>
        <hr>
        <li>
          <a href=""
            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 50 50" stroke-width="1.5" stroke="currentColor">
            ...
            <span class="ml-3">Halaman Depan</span>
          </a>
        </li>
    </ul>
  </div>
