...
@switch($name)
	...
	@case('chevron-right')
		@if ($type == 'stroke')
			...
			<img src="{{ asset('assets/arrow-right-solid.svg') }}" >
		@endif
	...
	@case('chevron-left')
		@if ($type == 'stroke')
			...
			<img src="{{ asset('assets/arrow-left-solid.svg') }}" >
		@endif
	@break
	...
	@case('setting')
		@if ($type == 'stroke')
		<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="w-{{ $size }} h-{{ $size }} {{ $class }}" viewBox="0 0 50 50"  stroke-width="{{ $strokeWidth }}" stroke="currentColor">
	...
	@case('respond')
		@if ($type == 'stroke')
		<svg xmlns="http://www.w3.org/2000/svg" class="w-{{ $size }} h-{{ $size }} {{ $class }}" viewBox="0 0 384 512" stroke-width="{{ $strokeWidth }}" stroke="currentColor">
			<image xlink:href="{{ asset('assets/respond.svg') }}"/>    
		</svg>
		@endif
	@break
